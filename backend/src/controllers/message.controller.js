...
import { sendMessage, getConversationMessages,markMessageAsRead,getUnreadMessageCount } from '../services/message.service.js';
...
export const getUnreadMessageCountController = asyncHandler(async (req, res) => {
